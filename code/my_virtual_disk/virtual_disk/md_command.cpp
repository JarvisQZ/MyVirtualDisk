...
void MKDIR(MyVirtualDisk* virtual_disk, std::string _path)
{
	...
	for (size_t i = 0; i < path_list.size(); ++i)
	{
		...
		if (i == 0 and (path_list[i] == "C:" or path_list[i] == ""))
		{
...
void MdCommand::Execute(MyVirtualDisk * virtual_disk)
{
	...
	{
		MKDIR(virtual_disk, command_parameters[0]);
	}
